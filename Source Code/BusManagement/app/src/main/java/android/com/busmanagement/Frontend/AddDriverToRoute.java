...
import android.com.busmanagement.Backend.AddDriverToRouteBackend;
import android.com.busmanagement.Backend.AllDriversListModel;
import android.com.busmanagement.Backend.AllRoutesListModel;
import android.com.busmanagement.Backend.GetUnassignedRoutesAndDrivers;
...
public class AddDriverToRoute extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener  {
    private ProgressDialog progressDialog;
    public ArrayList<AllRoutesListModel> listArrList;
    public ArrayList<AllDriversListModel> listArrListDriver;
    private Spinner spinner,driverSpinner;
    private GoogleMap mMap;
    private GoogleApiClient mGoogleApiClient;
    private LocationRequest locationRequest;
    private static final int PERMISSION_REQUEST_CODE = 1;
    private LocationManager locationManager;
    public String routeId,driverId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_driver_to_route);
        ...
        if (!gps_enabled) {
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(AddDriverToRoute.this);
    ...
    private void getALLRoutes() {
        ...
        if(NetUtils.isNetConnected(this)){
            GetUnassignedRoutesAndDrivers getUnassignedRoutesAndDrivers = new GetUnassignedRoutesAndDrivers(this);
            getUnassignedRoutesAndDrivers.viewRoute();
    ...
    private void setupProgressDialog() {
        ...
        progressDialog.setTitle("Downloading all unassigned routes & Drivers");
    ...
    public void setupSpinner(){
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                AddDriverToRoute.this.routeNo.setText(allRoutesListModel.getRouteNo());
                AddDriverToRoute.this.routeDescription.setText(allRoutesListModel.getRouteTitle());

                AddDriverToRoute.this.routeId = allRoutesListModel.getRouteId();
                ...
                try {
                    ...
                    for (int x = 0; x < allStopsJsonArray.length(); x++) {
                        ...
                        mMap.addMarker(new MarkerOptions().position(latLng).title(stopTitle));
                    }
        ...
        for (AllDriversListModel allDriversListModel: listArrListDriver) {
            drivers.add(allDriversListModel.getDriverName());
        }
        ArrayAdapter<String> dataAdapterForDrivers = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, drivers);
        dataAdapterForDrivers.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        driverSpinner.setAdapter(dataAdapterForDrivers);

        driverSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {

                AllDriversListModel allDriversListModel = listArrListDriver.get(i);
                AddDriverToRoute.this.driverId = allDriversListModel.getDriverId();
    ...
    public String getAddress(double lat, double lng) {
        Geocoder geocoder = new Geocoder(AddDriverToRoute.this, Locale.getDefault());
        try {
    ...
    public void addDriverToRoute(View view){
        AddDriverToRouteBackend addDriverToRouteBackend = new AddDriverToRouteBackend(this);
        addDriverToRouteBackend.addDriverToRoute();
