...
import android.com.busmanagement.Backend.GetAllRoutesInfoAdminBackend;
...
public class ViewRoutesInfoAdmin extends AppCompatActivity implements OnMapReadyCallback,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_routes_info);
        ...
        if (!gps_enabled) {
            ...
            AlertDialog.Builder dialog = new AlertDialog.Builder(ViewRoutesInfoAdmin.this);
    ...
    private void getALLRoutes() {
        ...
        if(NetUtils.isNetConnected(this)){
            GetAllRoutesInfoAdminBackend getAllRoutesInfoAdminBackend = new GetAllRoutesInfoAdminBackend(this);
            getAllRoutesInfoAdminBackend.viewRoute();
    ...
    public void setupSpinner(){
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ViewRoutesInfoAdmin.this.routeNo.setText(allRoutesListModel.getRouteNo());
                ViewRoutesInfoAdmin.this.routeDescription.setText(allRoutesListModel.getRouteTitle());
    ...
    public String getAddress(double lat, double lng) {
        Geocoder geocoder = new Geocoder(ViewRoutesInfoAdmin.this, Locale.getDefault());
        try {
