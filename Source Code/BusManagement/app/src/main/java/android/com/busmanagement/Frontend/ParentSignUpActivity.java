...
import android.com.busmanagement.Backend.ParentSignupBackend;
...
public class ParentSignUpActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void setupProgressDialog() {
        ...
        progressDialog.setTitle("Registering as Parent");
    ...
    public void onClick(View view) {
        ...
        {
        name=((EditText)findViewById(R.id.username_parent_signup)).getText().toString();
        email=((EditText)findViewById(R.id.email_parent_signup)).getText().toString();
        password=((EditText)findViewById(R.id.password_parent_signup)).getText().toString();
        confirm_password=((EditText)findViewById(R.id.confirm_password_parent_signup)).getText().toString();
        cnic_no=((EditText)findViewById(R.id.cnic_parent_signup)).getText().toString();
        mobile_no=((EditText)findViewById(R.id.mobile_parent_signup)).getText().toString();
        name=((EditText)findViewById(R.id.username_parent_signup)).getText().toString();
        email=((EditText)findViewById(R.id.email_parent_signup)).getText().toString();
        password=((EditText)findViewById(R.id.password_parent_signup)).getText().toString();
        confirm_password=((EditText)findViewById(R.id.confirm_password_parent_signup)).getText().toString();
        ...
        else
        {
            ...
            ParentSignupBackend parentSignupBackend = new ParentSignupBackend(this);
            parentSignupBackend.signup();
